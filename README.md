Control the player on the top with the up arrow to jump and side arrows to move. Control the player on the bottom with the w key to jump and a and d keys to move.
